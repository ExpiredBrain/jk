...
@if($data['data_from'] == 'category')
    @section('title',ucfirst($data['category_info']->meta_title))
@else
...
@push('css_or_js')
    ...
    @if($data['data_from'] == 'category')
    <meta name="title" content="{{$data['category_info']->meta_title}}"/>
        <meta name="description" content="{{ $data['category_info']->meta_description }}"/>
        <meta name="image" content="{{asset('storage/app/public/company')}}/{{$web_config['web_logo']->value}}"/>

        <meta property="og:image" content="{{asset('storage/app/public/company')}}/{{$web_config['web_logo']->value}}"/>
        <meta property="og:title" content="{{$data['category_info']->meta_title}}"/>
        <meta property="og:url" content="{!! addcslashes(url()->full(), "'") !!}"/>
        <meta property="og:description" content="{{ $data['category_info']->meta_description }}"/>

        <meta property="twitter:card" content="{{asset('storage/app/public/company')}}/{{$web_config['web_logo']->value}}"/>
        <meta property="twitter:title" content="{{$data['category_info']->meta_title}}"/>
        <meta property="twitter:url" content="{{url()->full()}}"/>
        <meta property="twitter:description" content="{{ $data['category_info']->meta_description }}"/>
    @else
        <meta property="og:image" content="{{asset('storage/app/public/company')}}/{{$web_config['web_logo']->value}}"/>
...
@php($decimal_point_settings = \App\CPU\Helpers::get_business_settings('decimal_point_settings'))
    ...
    <div class="container pb-5 mb-2 mb-md-4 rtl"
        ...
        <div class="row">
                                ...
                                @foreach($categories as $category)
                                    <div >
                                        <div class="card-header p-1 flex-between">
                                            <div>
                                                <a class="for-hover-lable" style="cursor: pointer" href="{{$category['slug']}}">
                                                    {{$category['name']}}
                                                </a>
                                            </div>
                                            <div>
                                        ...
                                        <div class="card-body {{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}"
                                            ...
                                            @foreach($category->childes as $child)
                                                <div class=" for-hover-lable card-header p-1 flex-between">
                                                    <div>
                                                        <a style="cursor: pointer" href="{{$child['slug']}}">
                                                            {{$child['name']}}
                                                        </a>
                                                    </div>
                                                    <div>
                                                ...
                                                <div
                                                    ...
                                                    @foreach($child->childes as $ch)
                                                        <div class="card-header p-1">
                                                            <a class="for-hover-lable" style="cursor: pointer" href="{{$ch['slug']}}">{{$ch['name']}}</a>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @endforeach
                                        ...
                                        <div class="card">
                                            ...
                                            <div
                                                ...
                                                @foreach($category->childes as $child)
                                                    <div class="card-header p-1 flex-between">
                                                        <div>
                                                            <a class="for-hover-lable" style="cursor: pointer" href="{{$child['slug']}}">
                                                                {{$child['name']}}
                                                            </a>
                                                        </div>
                                                        <div>
            ...
            <section class="col-lg-12 cat-description">
